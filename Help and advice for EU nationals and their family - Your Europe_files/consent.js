	...
	var _c = {
		...
		*/
		...
		showBanner: function() {
			...
			i.setAttribute('href','https://europa.eu/youreurope/citizens/scripts/cookie-consent/banner.css');
			h.appendChild(i);
			
			var i=doc.createElement('script');
				i.setAttribute('type','text/javascript');
				i.setAttribute('src','https://europa.eu/youreurope/citizens/scripts/cookie-consent/banner.js');
				h.appendChild(i);
